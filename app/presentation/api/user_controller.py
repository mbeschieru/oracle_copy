...
from app.presentation.dependencies.jwt_auth import get_current_user
...
def login(
    data: UserLoginDTO, service: UserService = Depends(get_user_service)
):
...
def get_current_user_info(current_user=Depends(get_current_user)):
    ...
    return UserReadDTO(
        ...
        project_id=(
            UUID(current_user.project_id) if current_user.project_id else None
        ),
    )
