from app.infrastructure.db.repositories.absence_repo_impl import (
    AbsenceRepository,
)
from app.infrastructure.db.repositories.attendance_repo_impl import (
    AttendanceRepository,
)
from app.infrastructure.db.repositories.meeting_attendance_repo_impl import (
    MeetingAttendanceRepository,
)
from app.infrastructure.db.repositories.meeting_repo_impl import (
    MeetingRepository,
)
from app.infrastructure.db.repositories.timesheet_repo_impl import (
    TimesheetRepository,
)
...
from app.use_case.services.meeting_attendance_service import (
...
def get_timesheet_service():
    return TimesheetService(
        timesheet_repo=TimesheetRepository(), user_repo=UserRepository()
    )
